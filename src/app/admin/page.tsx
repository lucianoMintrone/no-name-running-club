    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCardWithHelp
          ...
          helpText={dashboardHelp.fields.totalUsers}
          icon={
        ...
        <StatCardWithHelp
          ...
          helpText={dashboardHelp.fields.totalRuns}
          icon={
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <StatCardWithHelp
          ...
          helpText={dashboardHelp.fields.challenges}
          icon={
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <StatCardWithHelp
          ...
          helpText={dashboardHelp.fields.activeParticipants}
          icon={
            <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
